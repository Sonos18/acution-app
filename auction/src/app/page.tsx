  ...
  return (
    <>
      ...
      <div className="w-full mt-12">
        <div className="text-center text-4xl font-semibold">Lastest Auction</div>
        <svg className="mx-auto" width="515" height="32" viewBox="0 0 275 15" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="w-full my-8">
        ...
        <div className="flex relative">
          ...
          <TbMessageShare className="absolute left-1/2" size={40} color="#2695FF" />
        </div>
      </div>
      <LayoutGridAuction />
