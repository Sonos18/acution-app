...
export function Nav() {
    ...
    const handleItemClick = (event: React.MouseEvent<HTMLAnchorElement, MouseEvent>, index: Number, ref: string) => {
            ...
            <div className="grid grid-cols-10 gap-4 items-center ">
                ...
                <div className="col-span-2 ">
                    <div className="bg-slate-50 flex justify-center items-center rounded-md border-2 relative">
                        ...
                        <IoSearchSharp size={24} className="absolute right-1" color="#475569" />
